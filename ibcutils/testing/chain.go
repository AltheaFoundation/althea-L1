...
func NewTestChainAlthea(t *testing.T, coord *Coordinator, chainID string) *TestChain {
	...
	balance := banktypes.Balance{
		Address: acc.GetAddress().String(),
		Coins:   sdk.NewCoins(sdk.NewCoin(altheaconfig.BaseDenom, amount)),
	}

	app := SetupWithGenesisValSetAlthea(t, valSet, []authtypes.GenesisAccount{acc}, chainID, balance)
...
func SignAndDeliver(
	...
	tx, err := helpers.GenTx(
		txCfg,
		msgs,
		sdk.Coins{sdk.NewInt64Coin(altheaconfig.BaseDenom, 0)},
