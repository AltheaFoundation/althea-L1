...
use crate::utils::{
    execute_register_coin_proposal, get_fee, get_fee_option, get_test_token_name,
    get_unregistered_coin_for_erc20, get_user_key, one_eth, send_funds_bulk, EthermintUserKey,
    RegisterCoinProposalParams, ValidatorKeys, COINS_FOR_REGISTERING, MIN_GLOBAL_FEE_AMOUNT,
