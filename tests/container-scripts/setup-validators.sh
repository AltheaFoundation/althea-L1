...
ALLOCATION="${ALLOC_18_DECIMALS}${STAKING_TOKEN},${ALLOC_18_DECIMALS}ufootoken,${ALLOC_18_DECIMALS}aerc20coin1,${ALLOC_18_DECIMALS}aerc20coin2,${ALLOC_18_DECIMALS}aerc20coin3,${ALLOC_18_DECIMALS}aerc20coin4"
