...
var (
	...
	ErrGasfreeTokenNotAllowed = errorsmod.Register(ModuleName, 14, "token is not on gasfree interop list")
	ErrInsufficientAmount     = errorsmod.Register(ModuleName, 15, "insufficient amount (no fee collected)")
)
